...
function setup() {
  ...
  if (annyang) {
    ...
    let commands = {
      ...
      'when the bubble gum pops *animal': guessAnimal,
      'and remember every good time *animal': guessAnimal,
      'gumdear *animal': guessAnimal,
      'let them take *animal': guessAnimal,
      'thee *animal': guessAnimal,
      'your salty *animal': guessAnimal,
      'when put into my *animal': guessAnimal,
      'let them take *animal': guessAnimal,
    }
